  ...
  const copy =
    locale === "zh-CN"
      ? {
          ...
          onboarding: "V1 首次启动必须先明确选择 provider。当前构建完整支持 Anthropic。",
          apiKey: "API Key",
          apiHint: "当前构建从环境变量读取 provider 凭证。",
          provider: "Provider",
          providerHint: "前端会把所选 provider 显式传给 Rust 聊天和 V2 分析链路。",
          model: "模型",
          language: "语言",
          theme: "主题",
      ...
      : {
          ...
          provider: "Provider",
          providerHint: "The selected provider is passed explicitly to the Rust chat and V2 analysis pipeline.",
          model: "Model",
          language: "Language",
          theme: "Theme",
